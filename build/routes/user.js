...
function UserRouter(router) {
    ...
    router.post('/users/logout', auth_1.default, logoutUser);
    router.post('/users/logoutall', auth_1.default, logoutAllUser);
    return router;
}
exports.UserRouter = UserRouter;
function createUser(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var userModel, user, token, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    token = _a.sent();
                    return [2 /*return*/, res.status(201).send({ user: user, token: token })];
                case 3:
                    e_1 = _a.sent();
...
function logoutAllUser(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var e_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
